...
namespace Antmicro.Renode.Peripherals.UART
{
    ...
    public class ATCUART100 :  IBytePeripheral, IDoubleWordPeripheral, IUART, IKnownSize
    {
        public ATCUART100(bool wideRegisters = false)
        {
        ...
        private enum Register:uint
        {
            ...
            InterruptIdentification = 0x28,
            FIFOControl = 0x28,
            LineControl = 0x2c,
            ModemControl = 0x30,
            LineStatus = 0x34,
            PrescalerDivision = 0x34,
            // the same as Line Status but accessible only when DLAB bit is set
            LineStatusHack = 0x50,
            ModemStatusRegister = 0x38,
            TriggerLevelScratchpad = 0x3c,

            MultiModeInterruptEnable = 0x44,
            MultiModeControl0 = 0x50,
            MultiModeControl1 = 0x54,
            MultiModeControl2 = 0x58,
            FractionalDivisor = 0x5c,
            GlitchFilter = 0x64,
            TransmitterTimeGuard = 0x68,
            ReceiverTimeOut = 0x6c
        }
